...
def preprocess_data(raw_data_dir: FlyteDirectory) -> FlyteDirectory:
    ...
    # FlyteDirectory subclasses os.PathLike (I think) and I guess that's why this is possible to use os.path functions with it
    # but I've also seen examples of accessing the attributes
...
def wf(dir: FlyteDirectory) -> FlyteDirectory:
    # I'm going to try to use this to pass in strings to a directory and see what happens
